...
import { addToCart } from "../ToolKit/Reducers";
import Nav from "./Nav";
...
const gallary = [
  ...
  {
    id: nanoid(),
    url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwaSUPAvXVAbtDwDR7JWDVxz1sNby614SLwQ",
    price: 100,
    title: "ragdo",
    quantity: 1,
    originalPrice: 100,
...
export default function Menu() {
  ...
  function handleAddToCart(title, price, url, quantity, originalPrice, id) {
    const newCart = {
      id,
      title,
      price,
...
function MenuCard({
  ...
  return (
    <div className="menuCard">
      ...
      <button
        onClick={() =>
          onAddToCart(title, price, url, quantity, originalPrice, id)
        }
      >
        Add To cart
      </button>
